...
export class AuthService {
   ...
   * 
   * @alert GOOGLE-SPECIFIC PROBLEM
   *  If one does Google-specific login/registration there'll be problems where we cannot automatically
   *  redirect them to frontpage/registration form. Temporary FIX is to push the data received from
   *  backend to localstorage in this function BEFORE it's returned to login-component. Manual
   *  interaction will still be needed from user.
   * 
   */
