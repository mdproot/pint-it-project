# Yksikkotestauskirjaston importtaus
import unittest

# Verkkoajurin import
from selenium import webdriver

# "By"-komponentin importtaus helpottaa tyoskentelya
from selenium.webdriver.common.by import By

# Verkkoselaimen aikaongelmien ratkaisu
...
class purchaseTicketTest(unittest.TestCase):
   ...
   def setUp(self):
       ...
       # Ohjeistetaan Firefox avaamaan blazedemo
       self.driver.get("http://blazedemo.com")

       # Timeoutin alustus sille, kauanko odotetaan DOM-elementin loytymista
       self.driver.implicitly_wait(10)

       # Ikkunan koon maksimointi
   ...
   def find_flight_ticket(self):
       ...
       # Varmistetaan URLin oikeellisuus
   ...
   def purchase_flight(self):
       ...
       self.driver.find_element(By.ID, 'address').send_keys("25th Jameson Street")
